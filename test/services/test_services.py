...
class TestElasticLoadBalancing:
    def test_create_load_balancer_alb(self):
        with open('test/services/samples/elasticloadbalancing_CreateLoadBalancer_alb.json') as f:
            data = json.loads(f.read())
    ...
    def test_create_load_balancer_clb(self):
        with open('test/services/samples/elasticloadbalancing_CreateLoadBalancer_clb.json') as f:
            data = json.loads(f.read())
